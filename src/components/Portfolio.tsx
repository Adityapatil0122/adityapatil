      ...
      <div className="container mx-auto px-6">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech, techIndex) => (
                      <span 
                        key={techIndex}
                        className="px-3 py-1 bg-background rounded-full text-xs font-medium text-muted-foreground border border-border/50"
                      >
                        {tech}
                      </span>
                    ))}
        ...
        <div className="mt-16 text-center animate-fade-up">
          <Card className="max-w-4xl mx-auto border-border/50">
            <CardContent className="p-8">
              <h3 className="text-2xl font-semibold text-foreground mb-6">What's Coming Next</h3>
              <div className="grid md:grid-cols-3 gap-6 text-muted-foreground">
                <div className="space-y-2">
                  <h4 className="font-medium text-foreground">Advanced Java Projects</h4>
                  <p className="text-sm">Spring Boot applications with microservices architecture</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-medium text-foreground">AI/ML Applications</h4>
                  <p className="text-sm">Machine learning models for real-world problem solving</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-medium text-foreground">Full-Stack Platforms</h4>
                  <p className="text-sm">Complete web applications with modern tech stacks</p>
                </div>
              </div>
            </CardContent>
          </Card>
